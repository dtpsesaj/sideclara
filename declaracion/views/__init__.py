...
from .admin import (BusquedaDeclarantesFormView,
                    ...
                    descargarReportesExcel,
                    consultarDeclarantesExcel,
                    descargarReporteView,consultaEstatusTaskPDFReporte, consultaEstatusReporteExcel, eliminarProcesoPDFReporte,eliminarProcesoExcelReporte , consultarDeclaracionesAjax, consultarDeclarantesAjax,
