...
from declaracion.forms import (ObservacionesForm, DomiciliosForm, DeudasForm,InfoPersonalVarForm,PrestamoComodatoForm)
...
class DeudasView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if deudas_data:
            ...
            tercero_infopersonalvar = deudas_data.tercero_infopersonalvar if deudas_data.tercero_infopersonalvar else None
            print("tercero_infopersonalvar ------------>", tercero_infopersonalvar)
