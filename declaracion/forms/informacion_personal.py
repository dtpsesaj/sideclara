...
class DatosEncargoActualForm(forms.ModelForm):
    ...
    cat_areas_txt = forms.CharField(max_length=200, required=False, label="ÁREA DE ADSCRIPCIÓN")
    cat_puestos_txt = forms.CharField(max_length=200, required=False, label="EMPLEO, CARGO O COMISIÓN")
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['cat_areas_txt'].widget.attrs['readonly'] = True
        self.fields['cat_puestos_txt'].widget.attrs['readonly'] = True
