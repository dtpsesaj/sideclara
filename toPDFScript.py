...
def reportetoPDF(args):
    ...
    if parametros_busqueda['fecha_inicio_year'] and parametros_busqueda['fecha_inicio_month'] and parametros_busqueda['fecha_inicio_day']:
        fecha_inicio = date(int(parametros_busqueda['fecha_inicio_year']),int(parametros_busqueda['fecha_inicio_month']),int(parametros_busqueda['fecha_inicio_day']))
    ...
    #60% Del proceso ---------------------------------
    redis_cnx.hmset(tipo_reporte, {identificador:60})
    print("Filtrado completado-----------------> 60%")
