...
def serialize_datos_generales(declaracion):
    ...
    """
    print("declaracion --->", declaracion)
    info_personal_fija = declaracion.info_personal_fija
    info_personal_var = declaracion.infopersonalvar_set.filter(
        cat_tipo_persona=1
    ).first()
    print("info_personal_fija -->", info_personal_fija)
...
def declaracionesJsonView():
    ...
    with open('./static/declaraciones.json', 'w') as archivo_json:
