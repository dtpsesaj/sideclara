...
def actualizarHistoricoPuestos(id_info_personal_fija, tipo = None, object= None):
    ...
    try:
        ...
        if tipo == None:
            ...
            #Si existe ya un registro en historico, para agregar el nuevo, se actualiza la fecha fin de ese puesto
    ...
    try:
        if info_personal_fija.usuario.is_active:
            if tipo:
                if tipo == "INFOFIJA":
